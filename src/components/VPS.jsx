...
const VPS = () => {
  return (
    <div className="w-full bg-[#e9b1f6] flex px-10 pt-10 items-center">
      ...
      <div className="w-[39%] flex flex-col gap-4 text-[18px]">
        ...
        <div className="flex gap-2 items-center">
          ...
          <p>4.6 out of 5 starts based on 110,937 reviews </p>
